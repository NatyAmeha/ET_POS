            ...
            borderRadius: selectedBorderSidesForRadius == null
                ...
                : BorderRadiusDirectional.only(
                    topStart: Radius.circular(
                        selectedBorderSidesForRadius?.elementAtOrNull(0) ?? 0),
                    topEnd: Radius.circular(
                        selectedBorderSidesForRadius?.elementAtOrNull(1) ?? 0),
                    bottomEnd: Radius.circular(
                        selectedBorderSidesForRadius?.elementAtOrNull(2) ?? 0),
                    bottomStart: Radius.circular(
                        selectedBorderSidesForRadius?.elementAtOrNull(3) ?? 0),
                  ),
