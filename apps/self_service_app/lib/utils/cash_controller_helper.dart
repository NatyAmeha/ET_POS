...
class CashControllerDialogHelper {
  ...
  static bool isLeft =
      AppConstant.DEFAULT_CURRENCY_POSITION == 'before' ? true : false;
  static String? symbol = AppConstant.DEFAULT_CURRENCY_SYMBOL;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        "Total ${AppConstant.DEFAULT_CURRENCY_POSITION == 'before' ? AppConstant.DEFAULT_CURRENCY_SYMBOL! + totalOpeningBalance.toStringAsFixed(2) : totalOpeningBalance.toStringAsFixed(2) + AppConstant.DEFAULT_CURRENCY_SYMBOL!}",
                        style: Theme.of(context)
                            .textTheme
                            .headline5!
                            .copyWith(fontWeight: FontWeight.bold),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    coins!.forEach((element) {
                      if (element.initialValue != 0) {
                        String symbol =
                            AppConstant.DEFAULT_CURRENCY_POSITION == 'before'
                                ? AppConstant.DEFAULT_CURRENCY_SYMBOL! +
